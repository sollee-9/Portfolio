...
import wonder from "@/images/projects/wonder.png";
// skills
...
export const projects = [
  {
    ...
    description: `Wonder redefines management in the creator economy with an all-in-one platform that integrates project management, AI-driven communication tools, and data analytics
    
          As a founder, I spearheaded product development & strategy with particular focus on core product and led a multidisciplinary team of engineering, design and marketing
        `,
    url: "https://www.wonder-ai.co/",
